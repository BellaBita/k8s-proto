...
public class ExecExample {
  public static void main(String[] args)
      ...
      String podName = "lena-session-0";
      String commandLine = "sh -c ls -al";
      //run(namespace, podName, commandLine);
      ref(new String[]{"-p",podName,"-n",namespace, "/bin/bash"});
  }

  public static void run(String namespace, String podName, String commandLine)
      throws IOException, ApiException, InterruptedException {

    ApiClient client = K8sUtils.buildApiClient();
    Exec exec = new Exec(client);
    boolean tty = System.console() != null;
    // final Process proc = exec.exec("default", "lena-session-0", new String[]
